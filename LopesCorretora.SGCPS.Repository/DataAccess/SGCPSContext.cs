...
namespace LopesCorretora.SGCPS.Repository.DataAccess
{
	public class SGCPSContext : DbContext
	{
		...
		public DbSet<HistoricoDeRecebimentoPjMOD> HistoricoDeRecebimentosPj { get; set; }
		public DbSet<HistoricoDeRecebimentoPfMOD> HistoricoDeRecebimentosPf { get; set; }
		public DbSet<HistoricoDeDespesaMOD> HistoricoDeDespesas { get; set; }
